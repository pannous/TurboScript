...
var ParserContext = (function () {
    ...
    ParserContext.prototype.parseFunction = function (firstFlag, parent) {
        ...
        var nameRange;
        var name;
        var VOID = node_1.createName("void").withRange(token.range); // wtf api
        var ANY = node_1.createName("any").withRange(token.range); // wtf api
        var INT = node_1.createName("int").withRange(token.range); // wtf api
        var AUTO = node_1.createName("auto").withRange(token.range); // wtf api
        var DEFAULT_RETURN_TYPE = VOID;
        ...
        /////////////////////////////////////////
        if (name == "main") {
            var flag = new node_1.NodeFlag();
            flag.flag = node_1.NODE_FLAG_EXPORT;
            flag.next = firstFlag;
            firstFlag = flag;
        }
        node.firstFlag = firstFlag;

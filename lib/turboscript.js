...
Object.defineProperty(exports, "__esModule", { value: true });
const bitness_1 = __webpack_require__(22);
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/opt/TurboScript/src/bitness.ts'");
...
class ParserContext {
    ...
    expect(kind) {
        if (!this.peek(kind)) {
            if (kind == scanner_1.TokenKind.SEMICOLON)
                return true; // optional semicolon
            if (kind == scanner_1.TokenKind.COLON)

...
function testArray(num: int32): Array<int> {
	// log.printI32(num);
	// let a = new Array<Data>(num);
	// let a = new Array<any>(num);
	...
	let i = 0;
	while (i < num) {
		// let d = new Data(i) as any;// as Data
...
function testLoops(): int {
	...
	let wtf = 0;// variables can be declared after usage!? wtf what the fuck
	let count = 0;
		//
	// let i = 0;
	for let i = 5,k=10; i < 10; i++, k=k+10 do
		count++;
	end
	//count+
	return wtf + i
...
// let numbers = [1, 2, 3];
  ...
  // if(y)console.log(y)
  // return
  fib(21)+test()+count+3 #+Math.sqrt(44)
}
